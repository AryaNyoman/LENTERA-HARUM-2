    ...
    <header className="sticky top-0 z-20 border-b border-[var(--garis)] bg-[var(--kartu)]/95 backdrop-blur">
      <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-2.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-extrabold leading-tight text-[var(--teal-tua)]">
            SIMPUS-POSYANDU
          </p>
        ...
        <form action={keluar}>
          <button
            type="submit"
            className="rounded-lg border border-[var(--garis)] px-3 py-1.5 text-xs font-bold text-[var(--teks-sekunder)] hover:bg-[var(--bg)]"
          >
            Keluar
          </button>
        </form>
